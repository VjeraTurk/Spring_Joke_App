...
public interface JokeRepository extends JpaRepository<Joke, Integer>,CrudRepository<Joke, Integer> {
    ...
    /* ORDER BY 6, DESC, likes DESC -> nuzan drugi uvjet (a i treci) da se lista ne shuffla - SQL ne slijedi neko pravilo u slucaju 2 ista "score", vec svaki puta vrati drugacije
